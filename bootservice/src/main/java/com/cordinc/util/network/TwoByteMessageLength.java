 ...
 */
public final class TwoByteMessageLength implements IMessageLength {
	
	private final int NUM_BYTES = 2;
	private final long MAX_LENGTH = 65535;
	
	/**
	 * @see com.cordinc.IMessageLength.server.network.MessageLength#byteLength()
	 */
	...
	/**
	 * @see com.cordinc.IMessageLength.server.network.MessageLength#maxLength()
	 */
	...
	/**
	 * @see com.cordinc.IMessageLength.server.network.MessageLength#bytesToLength(byte[])
	 */
	...
	/**
	 * @see com.cordinc.IMessageLength.server.network.MessageLength#lengthToBytes(long)
	 */
