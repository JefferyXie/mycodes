...
/**
 * Another page with code example that one Selector with multiple Channel:
 * http://www.javaworld.com/article/2078654/java-se/java-se-five-ways-to-maximize-java-nio-and-nio-2.html
 * More examples:
 * http://archive.oreilly.com/pub/a/onjava/2002/09/04/nio.html?page=1
 * http://blog.csdn.net/a19881029/article/details/12611651
 * http://www.cnblogs.com/davidwang456/p/3831617.html
 * 
...
public abstract class AbstractServer implements Runnable {
     ...
     */
    protected AbstractServer(int port, IMessageLength messageLength, int defaultBufferSize) { 
    	this.port = port; 
    ...
    private ByteBuffer readMessage(SelectionKey key, ByteBuffer readBuffer) {
    	int bytesToRead; 
		// must have at least enough bytes to read the size of the message
